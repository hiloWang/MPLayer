package com.hhly.lawyer.data.cache;
...
//    public static final String INFO_BANNER = InfoBannerBean.class.getSimpleName();
//    public static final String INFO_MATCH = InfoMatchBean.class.getSimpleName();
    ...
    public void put(final String key, final Object object) {
        ...
        Reservoir.putAsync(key, object, new ReservoirPutCallback() {
            ...
            public void onSuccess() {
                Logger.i("log", "Put success: key=" + key + " object=" + object.getClass());
            }
